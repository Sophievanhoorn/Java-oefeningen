package module1._4_Functions.workbook4._03;
...
public class Weather {
	 ...
	 * 
	 *         Inside the function: 1. returns the temperature in celcius. C = (F -
	 *         32) * 5/9.
	 */
	 ...
	 * @param fahrenheit (double)
	 * 
	 *                   Inside the function: 1. prints: F: <temperature in
	 *                   fahrenheit>. 2. prints: C: <temperature in celsius> .
	 */
