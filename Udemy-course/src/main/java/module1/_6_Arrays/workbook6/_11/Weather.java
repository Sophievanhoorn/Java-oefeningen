...
public class Weather {
	 ...
	 *
	 *         Inside the function: 1. Creates a double[] array called 'fahrenheit'.
	 *         2. Copies all the values from celsius to fahrenheit. 3. Updates the
	 *         fahrenheit values (F = (C/5 * 9) + 32). 4. return fahrenheit.
	 */
	 ...
	 *
	 *                 Inside the function: 1. System.out.print(type + ": "); 2. A
	 *                 loop prints the temperatures in ONE line
	 *                 System.out.print(temp[i] + " "); 3. Prints a new line after
	 *                 the loop System.out.print("\n");
	 */
