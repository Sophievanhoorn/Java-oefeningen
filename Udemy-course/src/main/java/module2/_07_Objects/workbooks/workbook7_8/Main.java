...
public class Main {
	...
	/*
	 * Task 1 Inside the Airline class, add a constructor that does not receive any
	 * parameters.
	 * 
	 * Task 2 Inside the constructor, set people equal to a new array that can store
	 * 11 Person objects.
	 * 
	 * Task 3 Add a getter named getPerson that receives an int index and returns a
	 * Person object based on the index.
	 * 
	 * Task 4 Add a setter named setPerson that receives one parameter Person
	 * person.
	 */
